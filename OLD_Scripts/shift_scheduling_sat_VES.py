...
def solve_shift_scheduling(params, output_proto):
    ...
    # in week days only P1, P2
    fixed_assignments = []
    # for i in range(num_employees - 1):
    #     for d in range(7):
    #         shift0 = (i, 0, d)
    #         shift1 = (i, 1, d)
    #         fixed_assignments.append(shift0)
    #         fixed_assignments.append(shift1)

    # molinaro requests only sunday M1, M2
    fixed_assignments.append((num_employees-1, 2, 6))
    fixed_assignments.append((num_employees-1, 3, 6))
